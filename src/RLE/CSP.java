...
public class CSP {
	...
	public static void conseiller(String ad){
		System.out.print("Algorithme conseill� pour "+ad+" : ");
		switch(typeDe(ad)){
		case TEXTE:
	...
	public static void aide(){
		...
		System.out.println("	D�compresser           	: d[ID] source destination");
		...
		System.out.println("	Huffman optimis�	: [rh]");
		System.out.println("	RLE optimis�		: [rle]");
				...
				case 1:
					if(syntaxe[0].equals("q")||syntaxe[0].equals("Q")){
						...
						try{
							...
							System.out.println("Dossier de test renouvellé");
						}
						catch(Exception e){
						...
						try{
							...
							System.out.println("log renouvellé");
						}
						catch(IOException e){
				...
				case 2:
					if(syntaxe[0].equals("type")){
						...
						case HYBRIDE:
							...
							break;
						case DONNEES_COMPRESSEES:
							System.out.println(" : Donn�es compress�es");
							break;
						case INCONNU:
						...
						if(syntaxe[1].equals("0")){
							VERB=false;
							System.out.println("Le mode bavard est d�sactiv�");
						}
						else{
							VERB=true;
							System.out.println("Le mode bavard est activ�");
						}
					}
