...
public class BwtMtfRle extends Compression{
	...
	public void compresser(String fin, boolean v){
		System.out.println("----DEBUT DE COMPRESSION COMBIN�ES---");
		...
		System.out.println("----FIN DE COMPRESSION COMBIN�ES---");
		temps+=System.currentTimeMillis();
		System.out.println("Fin de la compression en "+temps+" ms");
	}
	public void decompresser(String fin, boolean v){
		System.out.println("----DEBUT DE D�COMPRESSION COMBIN�ES---");
		long temps=-System.currentTimeMillis();
		// m�me m�thode que pour la compression
		...
		System.out.println("----FIN DE D�COMPRESSION COMBIN�ES---");
		temps+=System.currentTimeMillis();
		System.out.println("Fin de la compression en "+temps+" ms");
	}
